  ...
  angular.module('ui.bootstrap.datetimepicker', [])
    ...
    .directive('datetimepicker', ['$log', 'dateTimePickerConfig', function datetimepickerDirective($log, defaultConfig) {
      ...
      function DateObject() {
        ...
        var validProperties = ['utcDateValue', 'localDateValue', 'display', 'active', 'selectable', 'past', 'future', 'isToday'];
      ...
      return {
        ...
        '<table class="table   {{ data.currentView }}-view">' +
        '   <thead>' +
        '       <tr class="cal-nav">' +
        '           <th class="left" data-ng-click="changeView(data.currentView, data.leftDate, $event)" data-ng-show="data.leftDate.selectable"><i class="fa fa-chevron-left"/></th>' +
        '           <th class="switch" colspan="5" data-ng-show="data.previousViewDate.selectable" data-ng-click="changeView(data.previousView, data.previousViewDate, $event)">{{ data.previousViewDate.display }}</th>' +
        '           <th class="right" data-ng-click="changeView(data.currentView, data.rightDate, $event)" data-ng-show="data.rightDate.selectable"><i class="fa fa-chevron-right"/></th>' +
        '       </tr>' +
        '       <tr>' +
            ...
            day: function day(unixDate) {
              ...
              for (var i = 0; i < 6; i += 1) {
                ...
                for (var j = 0; j < 7; j += 1) {
                  ...
                  var dateValue = {
                    'isToday': monthMoment.format('YYYY-MMM-DD') === today,
                    'utcDateValue': monthMoment.valueOf(),
