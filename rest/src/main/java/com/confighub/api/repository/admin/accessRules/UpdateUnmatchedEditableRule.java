...
@Path("/updateUnmatchedEditableRule")
public class UpdateUnmatchedEditableRule
        extends AAdminAccessValidation
{
    ...
    public Response update(@HeaderParam("Authorization") String token,
                           ...
                           @FormParam("unmatchedEditable") boolean unmatchedEditable)
    {
        ...
        try
        {
            ...
            store.begin();
            Team team = store.setTeamUnmatchedEditable(repository, user, teamName, unmatchedEditable);
            store.commit();

            json.addProperty("success", true);
            json.addProperty("unmatchedEditable", team.isUnmatchedEditable());
