        ...
        extends APersisted
{
    ...
    public Team(Repository repository, String name)
...
//    public boolean auditForceToggle;
    ...
    {
        if (null == this.accessRules) return 0;
    ...
    public Set<UserAccount> getMembers() { return this.members; }
